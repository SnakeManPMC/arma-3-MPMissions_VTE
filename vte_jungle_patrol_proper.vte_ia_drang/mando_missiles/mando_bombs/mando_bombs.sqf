...
private ["_plane","_target","_posp","_alt","_post","_posb","_deltaz","_dist","_disth","_vel","_continue","_ang","_pilot","_log","_type","_radio","_i","_mode","_behaviour","_crew","_sadarm","_failed_to_align","_los_log","_pos_asl","_ratev","_los_ok","_pos_ini","_j"];
mando_drop_bomb = 
{
