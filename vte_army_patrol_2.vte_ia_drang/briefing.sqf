...
switch (side player) do
{
	case WEST:
	{
		player createDiaryRecord ["Diary",["Mission","US army squad <marker name='start'>start</marker> at LZ X-Ray, patrol the area and clear <marker name='target1'>target 1</marker>, <marker name='target2'>target 2</marker> and <marker name='target3'>target 3</marker> locations."]];
