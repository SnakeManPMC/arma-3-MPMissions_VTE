...
private ["_ammo","_dur","_pos","_obj","_b2","_g","_rand","_interval_max","_disappear","_start_time","_end_time","_sleep","_orig_pos","_marker","_boxDim","_boxArray2","_maxZ","_launchZ"];
...
_orig_pos = getPosASL _ammo;
_marker = "ATMine_Range_Mag" createvehicle _orig_pos;
//flag1 setpos getPosASL _marker;
...
while {time <= _end_time} do
{
  ...
  case 1:  {
          ...
          if (_ammo isKindOf "Car") then
          {
             ...
             sleep .3;     
             _marker setpos getPosASL _ammo;
          } else 
          {
             sleep .3;
          };
