...
private["_plane", "_planetype", "_sadarm", "_targetpos", "_numberofattacks", "_targetpos", "_spawnpos", "_group", "_driver", "_ang", "_scr", "_friendlyside", "_spawned", "_list1", "_list2", "_cas", "_target", "_ntarget", "_targetpos","_bombtype","_attackalt", "_logasl"];
