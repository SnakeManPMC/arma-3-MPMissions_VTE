...
"VTE_vcsoldier" createUnit [getPosASL _vcleader, group _vcleader, "mike", 0, "PRIVATE"];
mike addEventHandler ["killed", {handle = _this execVM "PMC\PMC_killed.sqf"}];
