...
[[
  ["PMC_open_plei_me_base","Open Chi Lang base","You need to put boots on the ground on <marker name='markerPleiMe'>Chi Lang base</marker> to open your respawn there.", true, ["markerPleiMe", getPosASL PMC_pleimeopen]],
  ...
  ["Tips", "Viewdistance can be changed at the flag pole located in <marker name='start'>airbase</marker>.<br/><br/>Respawn location will be moved into Chi Lang Base when that objective is completed.<br/><br/>You can teleport from Chi Lang Base flag pole into airfield.<br/><br/>Vehicles has NO respawn, don't destroy your own vehicles! (only Jeeps have respawn)."]
