...
[[
  ["PMC_open_plei_me_base","Open Marine base","You need to put boots on the ground on <marker name='markerPleiMe'>Marine base</marker> to open your respawn there.", true, ["markerPleiMe", getPosASL PMC_pleimeopen]],
  ...
  ["Tips", "Viewdistance can be changed at the flag pole located in <marker name='start'>airbase</marker>.<br/><br/>Respawn location will be moved into Marine Base when that objective is completed.<br/><br/>You can teleport from Marine Base flag pole into airfield.<br/><br/>Vehicles has NO respawn, don't destroy your own vehicles! (only Jeeps have respawn)."]
