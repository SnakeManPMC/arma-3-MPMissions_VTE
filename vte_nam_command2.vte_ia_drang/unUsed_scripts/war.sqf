...
_NVA_Array = ["VTE_NVAaa","VTE_NVAengineer","VTE_NVAmg","VTE_NVAmedic","VTE_NVArecon","VTE_NVAreconrto","VTE_NVAsoldier","VTE_NVArpg","VTE_nvat","VTE_NVArto","VTE_NVAsapper","VTE_NVAmark","VTE_NVAsoldier"];
...
"VTE_vcofficer" createunit [getPosASL VC_Start, vcinf1, "e2 = this", _ran, "SERGEANT"]
[e2] join grpnull
_vc1 = group e2;
...
_SoldierSelect createunit [getPosASL VC_Start, vcinf1, "e1 = this", _ran, "CORPORAL"]
[e1] join grpnull;
[e1] join _vc1;
...
if (PMC_debug) then { player sidechat format["--- VC --- Created: %1 group: %2, east: %3",_B,_B+1,(count aieast)]; };
~.5
...
"VTE_NVAofficer" createunit [getPosASL VC_Start2, vcinf2, "e2 = this", _ran, "SERGEANT"]
[e2] join grpnull
_vc1 = group e2;
...
_SoldierSelect createunit [getPosASL VC_Start2, vcinf2, "e1 = this", _ran, "CORPORAL"]
[e1] join grpnull;
[e1] join _vc1;
...
if (PMC_debug ==1) then { player sidechat format["--- NVA --- Created: %1 group: %2, east: %3",_B,_B+1,(count aieast)]; };
~.5
...
"VTE_armywo" createunit [getPosASL US_Start, usinf1, "e2 = this", _ran, "SERGEANT"]
[e2] join grpnull
_vc1 = group e2;
...
_SoldierSelect createunit [getPosASL US_Start, usinf1, "e1 = this", _ran, "CORPORAL"]
[e1] join grpnull;
[e1] join _vc1;
...
if (PMC_debug) then { player sidechat format["--- US ARMY --- Created: %1 group: %2, west: %3",_B,_B+1,(count aiwest)]; };
~.5
...
"VTE_soldierwo" createunit [getPosASL US_Start2, usinf2, "e2 = this", _ran, "SERGEANT"]
[e2] join grpnull
_vc1 = group e2;
...
_SoldierSelect createunit [getPosASL US_Start2, usinf2, "e1 = this", _ran, "CORPORAL"]
[e1] join grpnull;
[e1] join _vc1;
...
if (PMC_debug) then { player sidechat format["--- MARINES --- Created: %1 group: %2, west: %3",_B,_B+1,(count aiwest)]; };
~.5
...
if (PMC_debug) then { player sidechat format["_creatoreast: %1, All: %2, Orig: %3, _creatorwest: %4, ALL: %5, Orig: %6",_CreatorEast,(count aieast),TotalEastorig,_CreatorWest,(count aiwest),TotalWestorig]; };
~5
...
if (PMC_debug) then { player sidechat format["leader: %1, move_pos: %2",(leader groupE1),move_pos]; };
~1
...
if (PMC_debug) then { player sidechat format["waiting %1 sec... VC kills: %2, VC orig: %3, Westcount: %4, WestOrig: %5, ALL: %6, Deaths All: %7",_LoopWait,TotalEastCount,TotalEastorig,TotalWestCount,TotalWestorig,(count aieast + count aiwest),(TotalEastCount+TotalWestCount)]; };
