...
switch (side player) do
{
	case WEST:
	{
		player createDiaryRecord ["Diary",["Mission","You are based in <marker name='us'>Plei Me SF base</marker>, proceed to clear the 4 targets marked on the map. Good luck."]];
