...
if (!isServer) exitWith
{
	...
	diag_log "PMC_lz_columbus activated, hint shown to player and exited while script continues to run on server.";
};
...
diag_log "PMC_lz_columbus.sqf has been executed.";
...
pmc_blufor_start_6 setPos _pos;
