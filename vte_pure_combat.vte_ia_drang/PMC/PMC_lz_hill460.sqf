...
{
	titleText ["LZ Hill460 has been seized, please hold the area secure until helicopter arrives and drops of supplies, thank you.", "plain down", 2];
	hint "LZ Hill460 has been seized, please hold the area secure until helicopter arrives and drops of supplies, thank you.";
	diag_log "PMC_lz_hill460 activated, hint shown to player and exited while script continues to run on server.";
};
...
_pos = getPosASL pmc_49;
_hq = getPosASL CV_helopad;

diag_log "PMC_lz_hill460.sqf has been executed.";
...
if (!alive _vcl || !canMove _vcl) exitWith
{
	...
	//hint "CH47 Chinook crashed, LZ Hill 460 is now closed. Sorry.";
};

// land the helo, shut down engine// landing helper object that the idiotic AI wont fly and fuck themselves up into some river or tree etc.
...
call compile preprocessFileLineNumbers "PMC\PMC_lz_hill460_objects.sqf";
