...
private _unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn1", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn1", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn1", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn1", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn1", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn1", [], .7, "form"];
...
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn1", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn1", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCmg", getMarkerPos "infspawn1", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCmg", getMarkerPos "infspawn1", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCmg", getMarkerPos "infspawn1", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCmg", getMarkerPos "infspawn1", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCmg", getMarkerPos "infspawn1", [], .7, "form"];
...
_grp addWaypoint [getmarkerpos "destination1", 0];
