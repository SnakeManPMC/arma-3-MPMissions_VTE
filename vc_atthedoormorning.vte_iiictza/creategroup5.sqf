...
private _unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn5", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn5", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn5", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn5", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn5", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn5", [], .7, "form"];
...
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn5", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn5", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCmg", getMarkerPos "infspawn5", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCmg", getMarkerPos "infspawn5", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCmg", getMarkerPos "infspawn5", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCmg", getMarkerPos "infspawn5", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCmg", getMarkerPos "infspawn5", [], .7, "form"];
...
_grp addWaypoint [getmarkerpos "destination5", 0];
