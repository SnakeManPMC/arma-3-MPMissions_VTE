...
private _unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn3", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn3", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn3", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn3", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn3", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn3", [], .7, "form"];
...
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn3", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCsoldier3", getMarkerPos "infspawn3", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCmg", getMarkerPos "infspawn3", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCmg", getMarkerPos "infspawn3", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCmg", getMarkerPos "infspawn3", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCmg", getMarkerPos "infspawn3", [], .7, "form"];
_unit = _grp createUnit ["VTE_VCmg", getMarkerPos "infspawn3", [], .7, "form"];
...
_grp addWaypoint [getmarkerpos "destination3", 0];
