/********************************************************************************* 
   ...
   Example:
      res = [_pos, objNull, side player, false, "AV8B2"]execVM"mando_missiles\mando_bombs\mando_basic_bombrun.sqf"

      of 

      res = [_pos, my_existing_plane, side player, false, ""]execVM"mando_missiles\mando_bombs\mando_basic_bombrun.sqf"

*********************************************************************************/

private["_plane", "_planetype", "_sadarm", "_spawned", "_friendlyside", "_targetpos", "_spawnpos", "_group", "_driver", "_ang", "_scr", "_attackalt", "_bombtype", "_attackalt", "_logasl"];
...
{
   _bombtype = "vte_mk82"; //Bo_GBU12_LGB
   _attackalt = 400;
};
...
Sleep 1;
_scr = [_plane, _targetpos, true, [2, 0, -2], _attackalt, _bombtype]execVM"mando_missiles\mando_bombs\mando_bombs.sqf";
