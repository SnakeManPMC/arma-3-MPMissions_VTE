...
private ["_x","_newUnit","_distNewUnit","_posIVNew","_posIVX","_vehicleNew","_vehicleX","_distX","_unitX","_newPosition","_newDirection","_newWeapons","_newMagazines","_weaponsCount","_magazinesCount","_posRespawn","_distMax","_respawnedWeapons","_respawnedMagazines","_members"];
