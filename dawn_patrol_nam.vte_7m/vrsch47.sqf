...
for [{}, {_run}, {_run}] do
{
	...
	_vcl addMagazinecargo ["VTE_20Rnd_556x45",20];
	_vcl addMagazinecargo ["VTE_7Rnd_1911",10];
	_vcl addMagazinecargo ["VTE_GrenadeRed",10];
	_vcl addMagazinecargo ["VTE_GrenadeGreen",10];
	_vcl addMagazinecargo ["Handgrenade",10];
	_vcl addMagazinecargo ["VTE_20Rnd_762x51_nato",20];
	_vcl addMagazinecargo ["VTE_5Rnd_762x51_nato",20];
	_vcl addMagazinecargo ["VTE_30Rnd_40mm_AmmoBag",15];
	_vcl addMagazinecargo ["VTE_1Rnd_40mm_HE",15];
	_vcl addMagazinecargo ["VTE_1Rnd_40mm_buckshot",15];
	_vcl addMagazinecargo ["VTE_100Rnd_762x51_M60",15];
	_vcl addMagazinecargo ["VTE_M72",5];
	_vcl addMagazinecargo ["VTE_100Rnd_556x45",10];
	_vcl addMagazinecargo ["SatchelCharge_Remote_Mag",10];
