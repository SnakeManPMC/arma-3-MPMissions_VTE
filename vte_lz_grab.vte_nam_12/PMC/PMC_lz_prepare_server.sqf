...
sleep _WaitTime;
_tmp = "vte_flagcarrier_usa" createVehicle _pos;
sleep _WaitTime;

_tmp = "Land_VTE_bis_mash" createVehicle _pos;
sleep _WaitTime;
_tmp = "Land_VTE_vilfire1" createVehicle _pos;
sleep _WaitTime;
_tmp = "Land_VTE_bis_Heli_H" createVehicle _pos;
sleep _WaitTime;
_tmp = "Land_VTE_vilbasket1" createVehicle _pos;
sleep _WaitTime;
